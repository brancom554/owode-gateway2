...
<html>
<head>
    <title>Owode payment page</title>
...
<?php
$currency = configItemData('payments.gateway_configuration.owode.currency');
$currencySymbol = configItemData('payments.gateway_configuration.owode.currencySymbol');
?>      
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#lwPaymentForm').on('submit', function(e){ 
            ...
            // owode script for send ajax request to server side start
                    ...
                    success: function (response) {
                      console.log()
                       //check server side validation
                        ...
                        //owode response
                        if(response.paymentOption == "owode") {
                           //on success load owodeUrl page
                            window.location.href = response.owodeUrl;
                        }
                    }
                });
            }
            // owode script for send ajax request to server side end
        });
    });
</script>
<!-- /  Jquery Form submit in script tag -->
