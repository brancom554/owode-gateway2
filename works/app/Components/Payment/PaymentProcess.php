...
class PaymentProcess {
    ...
    /**
     * @var owodeService - owode Service
     */
    ...
    function __construct($paytmService, $instamojoService, $iyzicoService, $owodeService, $paystackService, $razorpayService, $stripeService, $authorizeNetService, $bitPayService, $mercadopagoService) {
       $this->paytmService          = $paytmService;
       $this->instamojoService      = $instamojoService;
       $this->iyzicoService         = $iyzicoService;
       $this->owodeService         = $owodeService;
    ...
    { 
        ...
        } else if ($request['paymentOption'] == 'owode') {
            //get owode request data
            $processResponse = $this->owodeService->processowodeRequest($request);
            return $processResponse;
